...
public class Menu extends javax.swing.JPanel {
    ...
    public Menu() {
        ...
        initMenu();
        String name = com.login_forgot.login.usernameSend();
    ...
    private void initMenu() {
        ...
        addMenu("Users", "2", 1);
        addMenu("Members", "6", 2);
        addMenu("Payments", "8", 3);
        addMenu("Schedules", "4", 4);
        addMenu("Reports", "5", 5);
        addMenu("Settings", "7", 6);
    ...
    private void initComponents() {
        ...
        imageAvatar1.setGradientColor1(new java.awt.Color(102, 102, 255));
        imageAvatar1.setGradientColor2(new java.awt.Color(0, 51, 204));
        ...
        usernameTXT.setForeground(new java.awt.Color(154, 154, 154));
